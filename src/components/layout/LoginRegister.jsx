...
const LoginRegister = () => {
    ...
    return (
        <div
            className="flex justify-center items-center h-screen bg-gray-100" // Pastikan elemen parent full screen dan di tengah
        >
            <div
            ...
            >
                ...
                <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-r from-primary to-[#2EAD8D] text-white flex flex-col justify-center items-center px-10 space-y-5 transition-transform duration-700 transform">
                    ...
                    <button
                        ...
                        className="px-6 py-3 bg-white text-primary rounded-md font-semibold hover:bg-gray-200"
                    >
